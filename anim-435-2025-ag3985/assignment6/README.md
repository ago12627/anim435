...
Each time a reference is applied, this tool writes metadata to the default 'data' folder of the current directory with json of the respective asset name, current model version, maya scene, datetime, and user of the reference. Metadata files will be named under **'ASSET'.reference.json**. This tool assumes the current directory has a default data folder.
